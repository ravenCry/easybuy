	...
	<div id="product" class="main">
		...
		<div class="infos">
			...
			<div class="buy">
				...
				<div class="button"><input type="button" name="button" value="" onclick="goBuy(${ebProduct.id})" /><a href="shopping.do?action=insert&proname=${ebProduct.name}&proid=${ebProduct.id}&proprice=${ebProduct.price}">放入购物车</a></div>
			</div>
			<div class="clear"></div>
		</div>
		<div class="introduce">
